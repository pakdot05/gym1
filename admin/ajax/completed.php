...
if(isset($_POST['get_users'])) 
{
    ...
    // Select only the bookings with status 3 (Completed)
    $query = "SELECT * FROM `bookings` WHERE `status` = 3";
...
if(isset($_POST['search_user']))
{
    ...
    // Select only the bookings with status 3 (Completed) and name matching the search term
    $query = "SELECT * FROM `bookings` WHERE `status` = 3 AND `name` LIKE ?";
